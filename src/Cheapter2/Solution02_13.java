...
/*(Financial application: compound value) Suppose you save $100 each month into
        a savings account with the annual interest rate 5%. Thus, the monthly inter- est rate is
        ...
        displays the account value after the sixth month. (In Exercise 5.30, you will use a loop to simplify
...
public class Solution02_13 {
    public static void main(String[] args) {
        ...
        double total = 100 * (1 + INTEREST_RATE);

        total = (100 + total) * (1 + INTEREST_RATE);
