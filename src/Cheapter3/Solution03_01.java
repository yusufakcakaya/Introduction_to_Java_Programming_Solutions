package Cheapter3;
/*(Algebra: solve quadratic equations) The two roots of a quadratic equation ax2 + bx + c = 0
        ...
        the equation has two real roots. If it is zero, the equation has one root. If it is negative, the equation has no real roots.
